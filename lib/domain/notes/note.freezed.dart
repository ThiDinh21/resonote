...
mixin _$Note {
  ...
  ListOf3<TodoItem> get todos => throw _privateConstructorUsedError;
...
abstract class $NoteCopyWith<$Res> {
  ...
  $Res call(
      {UniqueID id, NoteBody body, NoteColor color, ListOf3<TodoItem> todos});
}
...
abstract class _Note extends Note {
  const factory _Note(
      ...
      required NoteBody body,
      required NoteColor color,
      required ListOf3<TodoItem> todos}) = _$_Note;
